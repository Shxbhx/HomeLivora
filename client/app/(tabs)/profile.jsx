    ...
    useEffect(() => {
        const fetchProfile = async () => {
            try {
                ...
                const response = await axios.get(`http://192.168.71.151:3000/users/${storedUserId}`);
    ...
    const handleShare = async () => {
        try {
            const result = await Share.share({
                message: 'Check out HomeLivora - The best app to find your dream home! ' +
                    'Download now: https://HomeLivora.com/download',
                title: 'Share HomeLivora App'
            });
        ...
        <View style={styles.container}>
            ...
            <View style={styles.profileHeader}>
                <Image 
                    source={{ 
                        uri: user.profilePic 
                            ? `http://192.168.71.151:3000/uploads/${user.profilePic}`
