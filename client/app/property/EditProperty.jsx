...
const EditProperty = () => {
  ...
  const fetchProperty = async () => {
    try {
      const response = await axios.get(`http://192.168.71.151:3000/admin/${id}`);
  ...
  const handleSave = async () => {
    try {
      ...
      const originalProperty = await axios.get(`http://192.168.71.151:3000/admin/${id}`);
      ...
      const response = await axios.put(
        `http://192.168.71.151:3000/admin/edit/${id}`, 
        updatedProperty,
        {
          headers: {
